function [output]=calculate_q(input)
% Compute q value starting from experimental angles
% Input is a vector of 6 components, which must be angles in degrees !
...
% gamma = tth, alpha = incident angle
...
test(i,:) = fnormal(myIPXO2(UB,phi,chi,om,alp,del,lambda,gam),9);
